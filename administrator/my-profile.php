...
?>
  <?php include('includes/header.php');?>
	...
	<?php
		...
		$UserDetails = $user->GetUser_Info( $_SESSION["Id"]);
	 ?>
                                      ...
                                      <div class="step-content pos-rel">
                                          <div class="step-pane active" data-step="1">
                                              <h3 class="lighter block green">Your information</h3>
													<?php foreach ($UserDetails as $fetchUserDetails) :?>
		 ...
		 bootbox.dialog({
			 ...
			 danger: {
				 ...
				 callback: function() {
					 ...
					 {
						 'Name': $('[name=FullName]').val(), 'Email': $('[name=email]').val(), 'Username': $('[name=Username]').val(), 'tags': $('[name=tags]').val(),
								...
								tag_input.tag(
								  {
									...
									//   $.ajax({url: '../custom/get-skills.php?q='+encodeURIComponent(query)})
