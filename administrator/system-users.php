									...
									<div class="row">
										<div class="col-xs-12">
											...
											<div>
												...
												<tbody>
												<?php
												$stmt = $db->prepare('SELECT * FROM profilemaster WHERE Id <> :Id ORDER BY Id DESC');
															...
															<div class="hidden-md hidden-lg">
 															 <div class="inline pos-rel">
 																 ...
 																 <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	 ...
																	 <li><a href="javascipt:void(0)" data-id="<?php echo $row['Id']; ?>" class="tooltip-success approve_user" data-rel="tooltip" title="Approve">
																		 <span class="green">
