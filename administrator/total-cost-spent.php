<?php
    ...
    $pagetitle ="Repair office against product model";
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Total Cost Spent Analysis</li>
						</ul><!-- /.breadcrumb -->
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="x_panel">
										<div class="x_title">
											<h2>Total Cost Spent Line Graph </h2>
											
											<div class="clearfix"></div>
										</div>

										<a class="btn btn-primary" id="link1" download="TotalCostSpentLineGraph.png" onclick="myFunction()">Save as png</a>
										<a class="btn btn-primary" id="link2" download="TotalCostSpentLine.jpg" onclick="myFunction()">Save as jpg</a>
...
<![endif]-->
		...
		<script src="chartjs/js/totalcost.js"></script>
		<!-- end of line chart -->
		<script type="text/javascript">
