				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Repair office against product model Analysis</li>
						</ul><!-- /.breadcrumb -->
					...
					<?php include('includes/nav-setings.php');?>
						...
						<div class="page-header">
							<h1>
							Repair office against product model Analysis
							...
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									...
									<div class="col-sm-12">
										<div class="x_panel">
										<div class="x_title">
											<h2>Repair office against product model Bar chart</small></h2>
											
											<div class="clearfix"></div>
										</div>
										<a class="btn btn-primary" id="link1" download="RepairofficemodelBarchart.png" onclick="myFunction()">Save as png</a>
										<a class="btn btn-primary" id="link2" download="RepairofficemodelBarchart.jpg" onclick="myFunction()">Save as jpg</a>
...
<![endif]-->
		...
		<script src="chartjs/js/repairoffice.js"></script>
		<!-- end of line chart -->
		<script type="text/javascript">
