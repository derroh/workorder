							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="x_panel">
										<div class="x_title">
											<h2>Product Model Pie chart </h2>
											
											<div class="clearfix"></div>
										</div>

										<a class="btn btn-primary" id="link1" download="ProductModelPiechart.png" onclick="myFunction()">Save as png</a>
										<a class="btn btn-primary" id="link2" download="ProductModelPiechart.jpg" onclick="myFunction()">Save as jpg</a>
...
<![endif]-->
		...
		<script src="chartjs/js/productmodel.js"></script>
		<!-- end of line chart -->
		<script type="text/javascript">

		function myFunction(){
			var url_base64 = document.getElementById("pie-chartcanvas-1").toDataURL("image/png");
            var url_base64jp = document.getElementById("pie-chartcanvas-1").toDataURL("image/jpg");
