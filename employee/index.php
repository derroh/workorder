						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-block alert-success">
									...
									Welcome to
									<strong class="green">
									KeySight Technologies Data Analysis System
													...
													<table id="dynamic-table" class="table table-striped table-bordered table-hover">
														<thead>
															<tr>
																...
																<th>Fail Age</th>
																<th>Fail Age In Years</th>
																<th></th>
															</tr>
														</thead>

														<tbody>
														<?php foreach ($systemdata as $item) :?>
															<tr>
																<td class="center">
																	<label class="pos-rel">
																		<input type="checkbox" class="ace" />
																...
																<td><?php echo strtoupper($item['Service Oder Number']); ?></td>
																<td><?php echo $item['Type/Class']; ?></td>
																<td><?php echo $item['Received Date']; ?></td>
																<td><?php echo $item['Part Cost']; ?></td>
																<td><?php echo $item['Labor Cost']; ?></td>

																<td><?php echo $item['Total Cost']; ?></td>
																<td><?php echo $item['Customer Name']; ?></td>
																<td><?php echo $item['Repair Office']; ?></td>
																<td><?php echo $item['ReportDate']; ?></td>
																<td><?php echo $item['Turnaround Time']; ?></td>

																
																<td><?php echo $item['Fail Age']; ?></td>
																<td><?php echo $item['Fail Age In Years']; ?></td>
																<td>
																</td>
															</tr>
															<?php endforeach; ?>
