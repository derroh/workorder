         ...
         $message.='width: 378px;" valign="top" align="left">';
          ...
          $message.='padding-bottom: 10px; padding-top: 15px;" valign="top" align="left">Thank you for signing up!</td></tr></tbody></table>';
           $message.='<div style="font-family: Arial, sans-serif; line-height: 20px; color: #444444; font-size: 13px;">';
             $message.='<b style="color: #777777;">We are excited to have you join Keysight Technologies</b>';
             $message.='<br>';
       ...
       $message.='font-weight: normal; padding-left: 36px; padding-right: 36px;" valign="top" align="left">';
         ...
         $message.='width: 378px;" valign="top" align="left">';
           $message.='<div style="font-family: Arial, sans-serif; line-height: 19px; color: #444444; font-size: 13px; text-align: center;">';
             $message.='<a href = "http://localhost/workorder/final-step?id='.$key.'&code='.$code.'" style="color: #ffffff; text-decoration: none; margin: 0px; text-align: center; vertical-align: baseline; border: 4px solid #6fb3e0; padding: 4px 9px; font-size: 15px; line-height: 21px; background-color: #6fb3e0;">&nbsp; Confirm &nbsp;</a>';
           $message.='</div>';
        ...
        $message.='13px; font-weight: normal; padding-left: 1px; padding-right: 1px;" valign="top" align="left">';
         ...
         $message.='valign="top" align="left">';
           $message.='<table width="100%" cellspacing="0" cellpadding="0" border="0" style="table-layout: fixed;"><tbody><tr><td width="100%" align="center" bgcolor="#f5f5f5" style="font-family: Arial, sans-serif; line-height: 24px; color: #bbbbbb; font-size: 13px; font-weight: normal; text-align: center;';
             ...
             $message.='<a href="#" style="color: #428bca; text-decoration: none; background-color: transparent;">Keysight Technologies &copy; 2018</a>';
             $message.='<br>';
             $message.='<a href="https://twitter.com/" style="color: #478fca; text-decoration: none; background-color: transparent;">Twitter</a>';
             $message.='.';
             $message.='<a href="https://www.facebook.com//" style="color: #5b7a91; text-decoration: none; background-color: transparent;">Facebook</a>';
             $message.='.';
             $message.='<a href="http://google.com/" style="color: #dd5a43; text-decoration: none; background-color: transparent;">Google+</a>';
           $message.='</td></tr></tbody></table>';
         $message.='</td></tr></tbody></table>';
       $message.='</td></tr></tbody></table>';
